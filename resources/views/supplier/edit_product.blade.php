        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ url('SupplierProduct', $product->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    @if($product->status)
                                                    <input name="publish" type="radio" checked id="customRadioInline1" value="{{$product->status}}" class="custom-control-input">
                                                        <label class="custom-control-label" for="customRadioInline1">Publish</label>
                                                        @else
                                                            <input name="publish" type="radio" id="customRadioInline1" value="{{$product->status}}" class="custom-control-input">
                                                    <label class="custom-control-label" for="customRadioInline1">Publish</label>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input name="new" type="checkbox" checked value="{{$product->new}}" class="custom-control-input" id="customCheck1">
                                                    <label class="custom-control-label" for="customCheck1">New Arrival</label>
                                                </div>
                                                @elseif($product->feature)
                                                <div class="custom-control custom-checkbox">
                                                    <input name="feature" checked value="{{$product->feature}}" type="checkbox" class="custom-control-input" id="customCheck2">
                                                    <label class="custom-control-label" for="customCheck2">Feature</label>
                                                </div>
                                                @elseif($product->sale)
                                                <div class="custom-control custom-checkbox">
                                                    <input name="sale" checked value="{{$product->sale}}" type="checkbox" class="custom-control-input" id="customCheck3">
