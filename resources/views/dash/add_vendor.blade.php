                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{url('vendor')}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="country" value="" id="product-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="company" value="" id="product-input">
                                        </div>
                                    </div>
                                   <div class="form-group row">
                                        <label for="example-search-input" class="col-2 col-form-label"> Plot/Shop Number</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="plot_number" value="" id="product-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="street_number" value="" id="product-input">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="sector" value="" id="product-input">
                                        </div>
                                    </div>
