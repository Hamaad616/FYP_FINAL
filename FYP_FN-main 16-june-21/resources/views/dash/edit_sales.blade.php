                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{url('sales', $sale->sale_id)}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" name="amount_received" value="{{$sale->amount_receive}}" placeholder="Amount Received" type="text"  id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="price[]" value="{{$sale->per_item_price}}" id="item-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-2 col-form-label">Cost</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="cost[]" value="{{$sale->cost}}" id="item-input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-url-input" class="col-2 col-form-label">No of products</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="noproduct[]" value="{{$sale->noproducts}}" id="quantity-input">
                                        </div>
