                            ...
                            <li><a href="{{ url('customer_shop_grid') }}">Categories <span><img src="portal/img/icon/hot.png" alt=""></span></a>
                                <ul class="submenu-mainmenu">
                                    @foreach($cats as $category)
                                        <li><a  href="{{ url('customer_shop_grid') }}"><i class="fa fa-circle"></i>{{$category->name}}<i class="fa fa-angle-right"></i></a>
                                        </li>
                                    @endforeach
                                </ul>
                            </li>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="tab-content mt-25">
                            <div id="grid" class="tab-pane active" role="tabpanel">
                                <div class="row">
                                    @foreach($category_id->products as $product)
                        ...
                        <div class="shop-left-sidebar">
                            <div class="single-left-widget">
                                <div class="section-title">
                                    ...
                                    <ul>
                                        @foreach($cats as $category)
                                            <li class="active"><a href="{{ url('customer_shop_grid') }}/{{$category->id}}"><i class="fa fa-angle-right"></i>{{ $category->name}} ({{$category->products->count()}})</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                       ...
                       <div class="container">
                           <div class="row">
                               <div class="col-md-4 col-sm-6">
                                   <div class="copyright">
                                       <p>Copyright @ 2019 <span><a href="{{url('/')}}">Croydon</a></span>. All right reserved. </p>
                                   </div>
                               </div>
                               <div class="col-md-4 col-sm-6">
