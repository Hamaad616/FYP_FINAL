            ...
            <div class="cart-section">
                <div>
                    ...
                    @if (Cart::instance('wishlist')->count() > 0)
                        ...
                        <h2>{{ Cart::instance('wishlist')->count() }} item(s) in Wishlist <span><a class="fa fa-bookmark"></a></span></h2>

                        <div class="cart-table">
                            @foreach (Cart::instance('wishlist')->content() as $item)
                                <div class="cart-table-row">
                                    <div class="cart-table-row-left">
                                        <a href="{{ url('product_detail', $item->model->id) }}"><img src="{{ asset('uploads/' .$item->model->slug.'/'. $item->model->product_image) }}" alt="item" class="cart-table-img"></a>
                                        <div class="cart-item-details">
                                            <div class="cart-table-item"><a style="text-decoration: none;" href="{{ url('product_detail', $item->model->id) }}">{{ $item->name }}</a></div>
                        ...
                        <div class="cart-buttons">
                            <a style="text-decoration: none !important;" href="{{ url('index_portal') }}" class="button">Continue Shopping</a>
                        </div>
